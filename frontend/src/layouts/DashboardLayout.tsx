...
const s: Record<string, React.CSSProperties> = {
    ...
    logoTag:      { fontSize: 11, color: `${GOLD}`, letterSpacing: 2, fontWeight: 400, margin: 0, textTransform: "uppercase" },
    ...
    navItemActive: { background: `linear-gradient(90deg, ${GOLD}10 0%, transparent 100%)`, color: GOLD, fontWeight: 500, borderLeftColor: GOLD },
